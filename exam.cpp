...
int main()
{
    ...
    printf("Enter no. of vertices of first polygon:");
    scanf("%d",&poly_size);
    printf("\nEnter  vertices:\n");
    for(int  i=0;i<poly_size;i++) {
        scanf("%d",&poly_points[i][0]);
        scanf("%d",&poly_points[i][1]);
    }
    printf("Enter no. of vertices of second polygon:");
    scanf("%d",&clipper_size);
    printf("\nEnter  vertices:\n");
    for(int  i=0;i<clipper_size;i++) {
        scanf("%d",&clipper_points[i][0]);
        scanf("%d",&clipper_points[i][1]);
    }
